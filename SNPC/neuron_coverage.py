    ...
    # def __init__(self, model, arc, threshold, num_classes=10, num_cluster=10):
        ...
        # for cla in range(num_classes):
            ...
            # for clu in range(num_cluster):
                ...
                # picked_samples_fname =os.path.join(root, 
                            # "cluster_paths/{}_binary_cluster/num_cluster{}_threshold{}_class{}_cluster{}_paths.pkl".format(
...
# #         print("{}, {}, {}, {}".format(self.class_num, self.total_cluster, bucket_m, self.layer_num))
...
# #                     continue
            # intra_paths = self.paths_all[label] 
            # for i, path in enumerate(intra_paths):
                # dises, _ = self.cal_path_similaity(path_x[index], path, simi_soft=simi_soft)
                # for j, layer_dis in enumerate(dises):
