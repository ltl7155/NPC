...
class VGG16(nn.Module):
    ...
    def forward(self,x):
        ...
        feature_dict['feat_conv1'] = feat_conv1.cpu()
        feat_bn1 = self.bn1(feat_conv1)
        feature_dict['feat_bn1'] = feat_bn1.cpu()
        feat_conv1_relu = self.relu1(feat_bn1)
        feature_dict['feat_conv1_relu'] = feat_conv1_relu.cpu()
        feat_conv2 = self.conv2(feat_conv1_relu)
        feature_dict['feat_conv2'] = feat_conv2.cpu()
        feat_bn2 = self.bn2(feat_conv2)
        feature_dict['feat_bn2'] = feat_bn2.cpu()
        feat_conv2_relu = self.relu2(feat_bn2)
        feature_dict['feat_conv2_relu'] = feat_conv2_relu.cpu()
        feat_pool1 = self.pool1(feat_conv2_relu)
        feature_dict['feat_pool1'] = feat_pool1.cpu()
        
        feat_conv3 = self.conv3(feat_pool1)
        feature_dict['feat_conv3'] = feat_conv3.cpu()
        feat_bn3 = self.bn3(feat_conv3)
        feature_dict['feat_bn3'] = feat_bn3.cpu()
        feat_conv3_relu = self.relu3(feat_bn3)
        feature_dict['feat_conv3_relu'] = feat_conv3_relu.cpu()
        feat_conv4 = self.conv4(feat_conv3_relu)
        feature_dict['feat_conv4'] = feat_conv4.cpu()
        feat_bn4 = self.bn4(feat_conv4)
        feature_dict['feat_bn4'] = feat_bn4.cpu()
        feat_conv4_relu = self.relu4(feat_bn4)
        feature_dict['feat_conv4_relu'] = feat_conv4_relu.cpu()
        feat_pool2 = self.pool2(feat_conv4_relu)
        feature_dict['feat_pool2'] = feat_pool2.cpu()
        
        feat_conv5 = self.conv5(feat_pool2)
        feature_dict['feat_conv5'] = feat_conv5.cpu()
        feat_bn5 = self.bn5(feat_conv5)
        feature_dict['feat_bn5'] = feat_bn5.cpu()
        feat_conv5_relu = self.relu5(feat_bn5)
        feature_dict['feat_conv5_relu'] = feat_conv5_relu.cpu()
        feat_conv6 = self.conv6(feat_conv5_relu)
        feature_dict['feat_conv6'] = feat_conv6.cpu()
        feat_bn6 = self.bn6(feat_conv6)
        feature_dict['feat_bn6'] = feat_bn6.cpu()
        feat_conv6_relu = self.relu6(feat_bn6)
        feature_dict['feat_conv6_relu'] = feat_conv6_relu.cpu()
        feat_conv7 = self.conv7(feat_conv6_relu)
        feature_dict['feat_conv7'] = feat_conv7.cpu()
        feat_bn7 = self.bn7(feat_conv7)
        feature_dict['feat_bn7'] = feat_bn7.cpu()
        feat_conv7_relu = self.relu7(feat_bn7)
        feature_dict['feat_conv7_relu'] = feat_conv7_relu.cpu()
        feat_pool3 = self.pool3(feat_conv7_relu)
        feature_dict['feat_pool3'] = feat_pool3.cpu()
        
        feat_conv8 = self.conv8(feat_pool3)
        feature_dict['feat_conv8'] = feat_conv8.cpu()
        feat_bn8 = self.bn8(feat_conv8)
        feature_dict['feat_bn8'] = feat_bn8.cpu()
        feat_conv8_relu = self.relu8(feat_bn8)
        feature_dict['feat_conv8_relu'] = feat_conv8_relu.cpu()
        feat_conv9 = self.conv9(feat_conv8_relu)
        feature_dict['feat_conv9'] = feat_conv9.cpu()
        feat_bn9 = self.bn9(feat_conv9)
        feature_dict['feat_bn9'] = feat_bn9.cpu()
        feat_conv9_relu = self.relu9(feat_bn9)
        feature_dict['feat_conv9_relu'] = feat_conv9_relu.cpu()
        feat_conv10 = self.conv10(feat_conv9_relu)
        feature_dict['feat_conv10'] = feat_conv10.cpu()
        feat_bn10 = self.bn10(feat_conv10)
        feature_dict['feat_bn10'] = feat_bn10.cpu()
        feat_conv10_relu = self.relu10(feat_bn10)
        feature_dict['feat_conv10_relu'] = feat_conv10_relu.cpu()
        feat_pool4 = self.pool4(feat_conv10_relu)
        feature_dict['feat_pool4'] = feat_pool4.cpu()
        
        feat_conv11 = self.conv11(feat_pool4)
        feature_dict['feat_conv11'] = feat_conv11.cpu()
        feat_bn11 = self.bn11(feat_conv11)
        feature_dict['feat_bn11'] = feat_bn11.cpu()
        feat_conv11_relu = self.relu11(feat_bn11)
        feature_dict['feat_conv11_relu'] = feat_conv11_relu.cpu()
        feat_conv12 = self.conv12(feat_conv11_relu)
        #feat_conv12 = self.conv12(feat_pool4)
        feature_dict['feat_conv12'] = feat_conv12.cpu()
        feat_bn12 = self.bn12(feat_conv12)
        feature_dict['feat_bn12'] = feat_bn12.cpu()
        feat_conv12_relu = self.relu12(feat_bn12)
        feature_dict['feat_conv12_relu'] = feat_conv12_relu.cpu()
        feat_conv13 = self.conv13(feat_conv12_relu)
        feature_dict['feat_conv13'] = feat_conv13.cpu()
        feat_bn13 = self.bn13(feat_conv13)
        feature_dict['feat_bn13'] = feat_bn13.cpu()
        feat_conv13_relu = self.relu13(feat_bn13)
        feature_dict['feat_conv13_relu'] = feat_conv13_relu.cpu()
        feat_pool5 = self.pool5(feat_conv13_relu)
        feature_dict['feat_pool5'] = feat_pool5.cpu()
        ...
        if self.if_dropout:
            ...
            after_dropout = feat_pool5
        
        feat_fc1 = self.fc1(after_dropout)
        feature_dict['feat_fc1'] = feat_fc1.cpu()
