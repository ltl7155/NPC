...
#                     r_values_per_conv.append(r_values_per_layer[-1])
#                 print("inverting", relevance.shape)
                relevance = self.inverter.compute_propagated_relevance(layer, relevance)
                if isinstance(layer, torch.nn.ReLU):
                    r_values_per_conv.append(relevance.cpu())
            ...
            return self.prediction, r_values_per_layer, r_values_per_conv
