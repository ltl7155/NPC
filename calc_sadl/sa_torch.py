...
def get_ats(
    ...
    Args:
        ...
        is_classification (bool): Task type, True if classification task or False.
         (int): The number of classes (labels) in the dataset.
...
#         print(prefix + "Processing ATs", type(layer_outputs))
#         print(prefix + "Processing ATs", type(layer_outputs[0]),layer_outputs[0].min(),layer_outputs[0].max())
#         print(prefix + "Processing ATs",  layer_outputs[0].shape)
#         print(prefix + "Processing ATs -->",  pred.shape,pred.dtype)
